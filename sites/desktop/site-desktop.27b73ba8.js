!(function (t) {
  ...
  function (t, e, n) {
    ...
    ;/ios|iphone|ipod|ipad|android/.test(Pe)
    function Re(t, e = '-') {
      return t
    ...
    console.log('config', z.a), console.log('documents', N)
    const { locales: Me, defaultLang: Ne } = z.a.site
    function De(t) {
      const e = t.path.split('/')[1]
      return -1 !== Object.keys(Me).indexOf(e) ? e : F
    }
    !(function (t) {
        ...
        return (
          ...
          e.forEach((e) => {
            const { component: n, lang: r } = (function (t) {
              if (-1 !== t.indexOf('_')) {
                const e = t.split('_')
                return { component: '' + Re(e.shift()), lang: e.join('-') }
              }
              return { component: '' + Re(t), lang: '' }
            })(e)
            'home' === n &&
              (function (e, n) {
